...
/* Le panneau mobile a ete sorti dans styles/nav.js, charge par toutes les
   pages : le code existait ici en double avec l'accueil, et il fallait
   l'apporter aux pages heritees sans en creer une troisieme copie. */
